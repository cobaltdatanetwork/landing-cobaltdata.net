        ...
        <VStack spacing={8} align="start" w="full">
          ...
          <Box w="full">
            <Text fontSize="lg" mb={4}>
              At Cobalt Data Network, we are committed to protecting your privacy and ensuring the security of your personal information. 
              This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website 
              at cobaltdata.net ("Website") or use our services.
            </Text>
            <Text fontSize="lg" mb={4}>
          ...
          <Box w="full" id="contact-us">
            ...
            <VStack align="start" spacing={2} pl={4}>
              <Text><strong>Privacy Team Email:</strong> privacy@cobaltdata.net</Text>
            ...
            <Text fontSize="md" mt={4}>
              ...
              form available at <Link color="blue.500" href="https://cobaltdata.net/privacy-request">cobaltdata.net/privacy-request</Link>.
            </Text>
            <Text fontSize="md" mt={4}>
