...
function WhistleblowerReportPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://apis.cobaltdata.net/api/v1/utils/whistleblower-report/', {
        method: 'POST',
        headers: {
      ...
      <Container maxW="800px" mx="auto" px={4} py={16} color="gray.800">
        <VStack spacing={8} align="start" w="full">
          ...
          <Box w="full" border="1px" borderColor="gray.200" p={6} borderRadius="md">
            ...
            <Text fontSize="md">
              We prohibit retaliation against whistleblowers. Report any retaliation to compliance@cobaltdata.net.
            </Text>
          </Box>
