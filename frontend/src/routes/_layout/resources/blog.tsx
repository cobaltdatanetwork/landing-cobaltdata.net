...
function BlogPage() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        const response = await fetch('https://raw.githubusercontent.com/CobaltDataNet/static/refs/heads/main/cobalt-blog-posts.json');
  ...
  return (
    <>
      <Box py={16} bg="blue.50" color="gray.800">
        ...
        <Heading as="h1" size="2xl" textAlign="center" mb={6} fontWeight="medium">Insights and Tutorials</Heading>
        <Text fontSize="xl" textAlign="center" mb={10} maxW="800px" mx="auto">In-depth articles, guides, and expert tips...</Text>
