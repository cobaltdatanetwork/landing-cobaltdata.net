...
function FAQPage() {
  ...
  const popularQuestions = [
    ...
    { 
      question: "What data sources can CobaltData connect to?", 
    ...
    { 
      question: "How is CobaltData different from other data platforms?", 
  ...
  const faqItems = [
    {
      question: "What is CobaltData and what problems does it solve?",
      answer: "CobaltData is a comprehensive data management platform that helps organizations integrate, process, govern, and analyze their data more effectively. Our platform solves key challenges including data silos, poor data quality, complex compliance requirements, and the difficulty of turning raw data into actionable insights. By providing a unified solution for the entire data lifecycle, CobaltData reduces the complexity, cost, and time required to build and maintain effective data infrastructure while enabling better, data-driven decision making."
    },
    {
      question: "What are the system requirements for using CobaltData?",
      answer: "As a cloud-native SaaS platform, CobaltData has minimal system requirements. Users need a modern web browser (Chrome, Firefox, Safari, or Edge), reliable internet connection, and appropriate permissions to access your organization's data sources. For the CobaltData Desktop Companion, we recommend Windows 10/11 or macOS 10.15+ with 8GB RAM and 2GB free disk space. Our mobile app requires iOS 14+ or Android 10+. For on-premises components or high-volume data processing, detailed requirements are provided during implementation planning."
    },
    {
    ...
    {
      question: "Does CobaltData offer an on-premises solution?",
      answer: "Yes, CobaltData offers flexible deployment options. While our platform is primarily cloud-based, we provide hybrid options for organizations with specific requirements. Our Edge Agent technology allows secure data processing within your firewall, with only processed results or metadata sent to the cloud. For enterprises with stringent data residency or regulatory requirements, we offer CobaltData Enterprise Private Cloud, which can be deployed in your own data centers or private cloud environment. This option maintains all the functionality of our cloud platform while keeping your data entirely within your infrastructure."
    },
    {
      question: "How does CobaltData ensure data quality?",
    ...
    {
      question: "What kind of support does CobaltData provide?",
    ...
    {
      question: "How does CobaltData handle compliance requirements?",
    ...
    {
      question: "What analytics capabilities does CobaltData provide?",
    ...
    {
      question: "What kind of scalability does CobaltData offer?",
