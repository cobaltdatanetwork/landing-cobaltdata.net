        ...
        <VStack spacing={8} align="start" w="full">
          ...
          <Box w="full">
            <Text fontSize="lg" mb={4}>
              At Cobalt Data Network, we are committed to maintaining the highest standards of regulatory compliance, 
          ...
          <Box w="full" id="contact-information">
            ...
            <VStack align="start" spacing={2} pl={4}>
              <Text><strong>Compliance Email:</strong> compliance@cobaltdata.net</Text>
            ...
            <Text fontSize="md" mt={4}>
              ...
              channel at <Link color="blue.500" href="https://cobaltdata.net/report">cobaltdata.net/report</Link>.
            </Text>
          </Box>
        </VStack>
      </Container>
