      ...
      <Box maxW="1200px" mx="auto" px={4}>
        <Grid templateColumns={{ base: "1fr", md: "2fr 1fr 1fr 1fr" }} gap={8} mb={8}>
          ...
          <Box>
            ...
            <Text color="gray.100" mb={4}>
              <strong>Phone:</strong> <a href="tel:+1‪8334353873‬">+1 ‪(833) 435-3873‬</a>
            </Text>
            <Text color="gray.100" mb={4}>
              <strong>Email:</strong>{' '}
        ...
        <Flex justify="space-between" align="center" borderTop="1px solid" borderColor="gray.700" pt={6} flexWrap="wrap" gap={4}>
          <Text color="gray.400" fontSize="sm">
            © 2025 <Link href="https://cobaltdata.net" color="gray.200" _hover={{ color: "blue.400" }}>Cobalt Data Network</Link>. All rights reserved.
          </Text>
          <Flex gap={6}>
