          ...
          <Flex align="center" justify="space-between" w="100%">
            ...
            >
              {currentUser ? (
                ...
                <Flex gap={2}>
                  <Button as={RouterLink} to="https://cloud.cobaltdata.net/signup" colorScheme="blue" variant="solid" size="sm">
                    Start Free Trial
                  </Button>
                  <Button as={RouterLink} to="https://cloud.cobaltdata.net/login" variant="outline" colorScheme="blue" size="sm">
                    Login
                  </Button>
                </Flex>
              )}
          ...
          <Flex flexDir="column" py={4}>
            ...
            {currentUser ? (
              ...
              <Flex flexDir="column" gap={2} px={4} py={2}>
                <Button
                  as={RouterLink}
                  to="https://cloud.cobaltdata.net/signup"
                  colorScheme="blue"
                  variant="solid"
                  size="sm"
                  onClick={onClose}
                ...
                <Button
                  as={RouterLink}
                  to="https://cloud.cobaltdata.net/login"
                  variant="outline"
                  colorScheme="blue"
                  size="sm"
                  onClick={onClose}
